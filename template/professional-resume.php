...
<link rel="stylesheet" href="../cvmaker-assets/css/resume_css/resume.css?v=<?php echo time(); ?>">
<link rel="stylesheet" href="../cvmaker-assets/css/resume_css/proTemp.css?v=<?php echo time(); ?>" type='text/css'>
    ...
    <div class="sheet">
        ...
        <div class="rela-block page">
            ...
            <div class="side-bar">
                <div class="mugshot">
                    <div class="logo">
                        <?php echo "<img src='assets/images/" . $row['user_img'] . "' alt='' height='100%' width='100%'>"; ?>

                        <!-- <p class="logo-text">kj</p> -->
                    </div>
                </div>
                <p class="context">PHONE: <span>+<a href="tel:<?php echo "$row[5]"; ?>"><?php echo "$row[5]"; ?></a> </span>
                </p>
                <p class="context">EMAIL: <span><a href="mailto:<?php echo "$row[4]"; ?>"><?php echo "$row[4]"; ?></a></span>
                </p>
            ...
            <div class="rela-block content-container">
                ...
                <p class="light"><?php echo " $row[9] "; ?>
                    <span><?php echo " $row[10] "; ?>-<?php echo " $row[11] "; ?><br><span><?php echo " $row[8] "; ?></span></span>
                </p>
                ...
                <h3>Education</h3>
                <p class="light"><?php echo " $row[14] "; ?>
                    <span><?php echo " $row[17] "; ?><br><span><?php echo " $row[15] "; ?></span></span>
                </p>
                <p class="justified"><?php echo " $row[19] "; ?></p>

                <h3>Languages</h3>

                <p class="light"> <?php echo " $row[24] "; ?> - <?php echo " $row[25] "; ?><br><span><?php echo " $row[26] "; ?>
                        -
                        <?php echo " $row[27] "; ?></span></p>

                <h3>Reference</h3>
                <p class="light">
                    <?php echo " $row[28] "; ?>from<?php echo " $row[29] "; ?>-<span><?php echo " $row[34] "; ?>-<?php echo " $row[35] "; ?></span></span>
                </p>
