...
<link rel="stylesheet" href="../cvmaker-assets/css/resume_css/bootstrap.css?v=<?php echo time(); ?>">

<link rel="stylesheet" href="../cvmaker-assets/css/resume_css/dashboard.css?v=<?php echo time(); ?>">
...
<div class="clearfix" id="myContent">
    <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="details">
            ...
            <p><i class="fas fa-phone pr-2"></i>+<a href="tel:<?php echo "$row[5]"; ?>"><?php echo "$row[5]"; ?>
            </p>
            <h3>EMAIL</h3>
            ...
            <address>
                <h3>ADDRESS</h3>
                <span>
                    <p><i class="fas fa-map-marker-alt pr-1"></i><?php echo " $row[6] "; ?>
                </span>
            </address>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="content">
            ...
            <div class="company">
                ...
                <div class="company_details">
                    <h4><?php echo " $row[9] "; ?> <span><?php echo " $row[10] "; ?>-<?php echo " $row[11] "; ?></span>
                    </h4>
            ...
            <div class="company">
                ...
                <div class="company_details">
                    <h4> <?php echo " $row[28] "; ?>from<?php echo " $row[29] "; ?><span><?php echo " $row[34] "; ?>-<?php echo " $row[35] "; ?></span>
                    </h4>
                    <h6></h6>
