...
if ($username == $row[3]) {
  if (isset($_SESSION["username"])) {
    ...
    ?>
      ...
      <link rel="stylesheet" href="../cvmaker-assets/css/resume_css/resumetemp1.css?v=<?php echo time(); ?>" type='text/css'>
          ...
          <div class="section">
            ...
            <div class="skills">
              <div class="skills__item">
                <div class="left">
                  <div class="name">
                    <?php echo " $row[20] " ?> - <?php echo " $row[21] " ?>
                  </div>
                </div>
          ...
          <div class="section">
            ...
            <div class="skills">
              <div class="skills__item">
                <div class="left">
                  <div class="name">
                    <?php echo " $row[22] " ?> - <?php echo " $row[23] " ?>
                  </div>
                </div>
